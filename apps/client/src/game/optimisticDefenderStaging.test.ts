...
describe("optimistic defender staging", () => {
  it("projects requested hand, equipment, board, and hero cards without mutating rules state", () => {
    ...
    const projected = optimisticDefenderView(view, 0, [11, 12, 13, 100]);
