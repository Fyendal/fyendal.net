...
export type GameIntent =
  ...
  | { kind: "activate-ability"; sourceInstanceId: number; pitchInstanceIds: number[]; pitchRequired?: number; abilityIndex?: number; targetAllyId?: number; alternativeCostCardInstanceIds?: number[]; /** Presentation hint: this activation pauses on a declaration or additional-cost choice before costs are paid. */ deferActivationPresentation?: true }
  | { kind: "pass" }
