...
export type GameIntent =
  ...
  | { kind: "activate-ability"; sourceInstanceId: number; pitchInstanceIds: number[]; pitchRequired?: number; abilityIndex?: number; targetAllyId?: number; alternativeCostCardInstanceIds?: number[]; /** Presentation hint: wait for the authoritative result instead of projecting this activation. */ deferActivationPresentation?: true }
  | { kind: "pass" }
