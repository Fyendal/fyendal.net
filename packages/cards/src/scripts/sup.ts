...
Object.assign(sup, {
  ...
  "big bully|1": { onAttackDeclared(ctx: ScriptCtx) { if (ctx.link?.targetAllyId === undefined && ctx.compareLife(ctx.seat, opponentSeat(ctx)) > 0) ctx.crowdBoo(ctx.seat); }, modifyAttack(ctx: ScriptCtx) { return ctx.getFlag("player", "booedThisTurn") ? ctx.basePower(ctx.self) : 0; } },
