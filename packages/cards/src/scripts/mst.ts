...
Object.assign(mst, {
  ...
  "restless coalescence|2": {
    ...
    wardValue: () => 2,
    activated: { cost: 0, isAttack: false, goAgain: false, timing: "instant", oncePerTurn: true, removeCounterCost: { key: "power", amount: 1 }, canActivate: (ctx) => ctx.getCounter("power") > 0, onActivate(ctx) { ctx.createToken(SPECTRAL_SHIELD); } },
  },
