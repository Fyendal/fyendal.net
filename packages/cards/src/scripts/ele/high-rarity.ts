...
export const eleHighRarity: Record<string, CardScript> = {
  ...
  "spellbound creepers|0": {
    activated: { cost: 1, isAttack: false, goAgain: false, timing: "instant", oncePerTurn: true, putCounterCost: { key: "bind", amount: 1 }, canActivate(ctx) { return ctx.getFlag("player", "playedSubtype:attack") === true || ctx.getFlag("player", "defendedWithAttackActionThisTurn") === true; }, onActivate(ctx) { ctx.setFlag("player", "nextNonAttackAsInstant", true); } },
